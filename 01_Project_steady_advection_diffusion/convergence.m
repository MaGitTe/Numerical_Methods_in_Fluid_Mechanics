...
%% 3. Expressing the analytical solution as an anonymous function: ------ %
...
for j = 1:length(dx_list)
    ...
    % Analytical Solution at x = [0.25, 0.5, 0.75]
    c_ana = f_ana(x, Pe);
    ...
    e_1(j) = norm(c_ana - c_num(slicing_index));    
...
%% 6. Saving our figure as 'convergence.png': --------------------------- %

disp('Saving the figure as convergence.png...');
